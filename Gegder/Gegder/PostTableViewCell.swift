...
class PostTableViewCell: UITableViewCell {
    ...
    @IBAction func PostLikeButtonTouch(sender: UIButton) {
        ...
        if IsDislike == false {
            ...
            NSURLConnection.sendAsynchronousRequest(request, queue: queue, completionHandler: { (response: NSURLResponse!, data: NSData!, error: NSError!) -> Void in
                if data != nil {
                    ...
                    if str == "completed" {
                        ...
                        self.homeView!.data.likePost(self.PostId!)
            ...
            self.homeView?.presentViewController(dislikeAlert, animated: true, completion: nil)
        }
    }
            ...
            NSURLConnection.sendAsynchronousRequest(request, queue: queue, completionHandler: { (response: NSURLResponse!, data: NSData!, error: NSError!) -> Void in
                if data != nil {
                    ...
                    if str == "completed" {
                        ...
                        // Update post entry variable in HomeViewController (backend data)
                        self.homeView!.data.dislikePost(self.PostId!)
